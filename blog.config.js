...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '2ee83f441cfa81fcb5efd0da4ac6d649',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Zflyee', // 您的昵称 例如 tangly1024
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || 'https://raw.githubusercontent.com/BetterZflyee/MyAssets/main/avatar.jpg', // 默认头像
  HOME_BANNER_IMAGE: process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/cover.webp', // 首页封面大图
  BIO: process.env.NEXT_PUBLIC_BIO || 'zflyee的AI数字花园.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zflyee.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI, Founder, Digital Transformation, Portfolio', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，他是朱飞（Felix），昵称Zflyee(微信)，一名AI架构师与数字化转型专家~\n长期乐观，短期悲观，当下愉悦。\n如果这里对你有帮助，请您不妨停下来看看~',
